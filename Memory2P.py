...
class MemGame(tk.Frame):
    def __init__(self, master):
        ...
        # plain text PNGs
        photo_dog_text = tk.PhotoImage(file="Ressurser/Dyr/dogtext.png")
        photo_elephant_text = tk.PhotoImage(file="Ressurser/Dyr/elephanttext.png")
        photo_flamingo_text = tk.PhotoImage(file="Ressurser/Dyr/flamingotext.png")
        photo_hippo_text = tk.PhotoImage(file="Ressurser/Dyr/hippotext.png")
        photo_camel_text = tk.PhotoImage(file="Ressurser/Dyr/cameltext.png")
        photo_cat_text = tk.PhotoImage(file="Ressurser/Dyr/cattext.png")
        ...
        # cardback
        photo_cardback = tk.PhotoImage(file="Ressurser/GUI elementer/cardback2P.png")
